          ...
          <transition name="flip" mode="out-in">
            <b-card border-variant="primary" no-body v-if="!showHelp" key="login">
              <b-card-header>
                <div class="row">
                  ...
                  <b-link class="ml-auto mx-2" @click="toggleHelp">
            ...
            <b-card no-body v-if="showHelp" key="loginHelp">
              ...
              <b-card-body>
                ...
                <b-button @click="toggleHelp" class="ml-auto" variant="primary" size="sm">Back to Login</b-button>
              </b-card-body>
            </b-card>
          </transition>
        </div>
...
export default {
  ...
  computed: {
    isStatusMessage() {
      return this.statusMessage && this.statusMessage.length > 0;
    },
  },
  mounted() {
